...
linkml_meta = LinkMLMeta({'default_prefix': 'mondo_src',
     ...
     'prefixes': {'IAO': {'prefix_prefix': 'IAO',
                  ...
                  'ONCOTREE': {'prefix_prefix': 'ONCOTREE',
                               'prefix_reference': 'http://purl.obolibrary.org/obo/mondo/sources/oncotree/'},
                  'UMLS': {'prefix_prefix': 'UMLS',
                           'prefix_reference': 'http://linkedlifedata.com/resource/umls/id/'},
...
class OntologyTerm(ConfiguredBaseModel):
    ...
    term_replaced_by: Optional[str] = Field(default=None, description="""Single active replacement (IAO term replaced by); use with obsolete terms.""", json_schema_extra = { "linkml_meta": {'annotations': {'owl': {'tag': 'owl', 'value': 'AnnotationAssertion'}},
         'domain_of': ['OntologyTerm'],
         'slot_uri': 'IAO:0100001'} })
    consider: Optional[list[str]] = Field(default=None, description="""Multiple replacement candidates (oboInOwl consider); use when a term splits.""", json_schema_extra = { "linkml_meta": {'annotations': {'owl': {'tag': 'owl', 'value': 'AnnotationAssertion'}},
         'domain_of': ['OntologyTerm'],
         'slot_uri': 'oboInOwl:consider'} })
    rdfs_comment: Optional[list[str]] = Field(default=None, description="""Free-text comments (e.g. OncoTree main type, tissue, level).""", json_schema_extra = { "linkml_meta": {'annotations': {'owl': {'tag': 'owl', 'value': 'AnnotationAssertion'}},
         'domain_of': ['OntologyTerm'],
